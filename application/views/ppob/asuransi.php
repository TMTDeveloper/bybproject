...
<section class="content">
    ...
    <div class="box-header with-border">
        <h3 class="box-title" name="subKategori" id="subKategori" value="ASURANSI">Asuransi</h3>
    ...
    <div class="box-body">
        ...
        <input name="subKategori" id="subKategori" value="POLIS" hidden> <!-- mencocokan dengan xresponecode / setara dengan sub kategori ID -->
