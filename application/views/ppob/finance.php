...
<section class="content">
    ...
    <div class="box-header with-border">
        <h3 class="box-title" name="subKategori" id="subKategori" value="FINANCE">FINANCE</h3>
    ...
    <div class="box-body">
        ...
        <input name="subKategori" id="subKategori" value="FINANCE" hidden> <!-- mencocokan dengan xresponecode -->
