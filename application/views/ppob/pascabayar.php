...
<section class="content">
    ...
    <div class="box-header with-border">
        <h3 class="box-title" name="subKategori" id="subKategori" value="PASCABAYAR">PASCABAYAR</h3>
    ...
    <div class="box-body">
        ...
        <input name="subKategori" id="subKategori" value="PASCABAYAR" hidden> <!-- mencocokan dengan xresponecode -->
