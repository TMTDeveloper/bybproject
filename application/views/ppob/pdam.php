...
<section class="content">
    ...
    <div class="box-header with-border">
        <h3 class="box-title" name="subKategori" id="subKategori" value="PDAM">PDAM</h3>
    ...
    <div class="box-body">
        ...
        <input name="subKategori" id="subKategori" value="PDAM" hidden> <!-- mencocokan dengan xresponecode -->
