...
<section class="content">
    ...
    <div class="box-body">
         ...
         <div class="form-group">
            ...
            <option>Telkom TV</option>
            </select>
            </div>
        </div>

        <div class="form-group">
            <label for="inputKodeArea" class="col-sm-2 control-label">Kode Area</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="inputNoTel" class="col-sm-2 control-label">Nomor Telepon</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" id="inputNoTel" placeholder="000000000000"  style="width: 70%;">
            </div>
        </div>
